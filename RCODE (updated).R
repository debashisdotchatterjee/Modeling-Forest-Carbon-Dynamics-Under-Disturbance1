...
library(readr)
write.csv(soil_df, "C:/Users/SUBHRAJIT SAHA/Documents/soil_df.csv", row.names = FALSE)
write.csv(df, "C:/Users/SUBHRAJIT SAHA/Documents/df.csv", row.names = FALSE)
write.csv(subplots, "C:/Users/SUBHRAJIT SAHA/Documents/subplots.csv", row.names = FALSE)
